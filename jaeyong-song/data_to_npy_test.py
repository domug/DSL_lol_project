...
df_240 = pd.read_csv("./final_data_processed/Test/challenger_24.csv")
df_255 = pd.read_csv("./final_data_processed/Test/challenger_25.5.csv")
df_270 = pd.read_csv("./final_data_processed/Test/challenger_27.csv")
df_285 = pd.read_csv("./final_data_processed/Test/challenger_28.5.csv")
df_300 = pd.read_csv("./final_data_processed/Test/challenger_30.csv")
